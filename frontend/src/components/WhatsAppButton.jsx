...
const WhatsAppButton = ({ settings }) => {
  ...
  const formattedPhone = rawDigits.startsWith('91') && rawDigits.length > 10
    ? rawDigits 
    : `91${rawDigits.slice(-10)}`;

  const prefilledMessage = encodeURIComponent(
    "Hello Teja Software Technology, I would like to know more about your software courses and services."
  );

  const whatsappUrl = `https://wa.me/${formattedPhone}?text=${prefilledMessage}`;
  ...
  return (
    <a
      ...
      aria-label="Chat with Teja Software Technology on WhatsApp"
