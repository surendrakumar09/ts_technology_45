...
class WebsiteSetting(models.Model):
    ...
    email = models.EmailField(default="tssoftwaretechnology@gmail.com")
    ...
    social_instagram = models.URLField(blank=True, default="https://www.instagram.com/tstechnology.co.in/")
